...
export interface ApiEnollmentEnollment extends Struct.CollectionTypeSchema {
  collectionName: 'enollments';
  info: {
    description: '';
    displayName: 'Enrollment';
    pluralName: 'enollments';
    singularName: 'enollment';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTrainerTrainer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Date_Employed: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::trainer.trainer'
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    educational_attainment: Schema.Attribute.String;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
      }>;
    employment: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    reference_num: Schema.Attribute.String;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
